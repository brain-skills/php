...
let answerNumber  = Math.floor((minValue + maxValue) / 2); // находим центральное число диапазона
let orderNumber = 1; // начальный номер вопроса
let gameRun = true; // включаем игру
...
const orderNumberField = document.getElementById('orderNumberField'); // переменная для вывода № вопроса
const answerField = document.getElementById('answerField'); // переменная для вывода вариантов ответа
orderNumberField.innerText = orderNumber; // присваиваем номер вопроса
