var personGenerator = {
    ...
    getPerson: function (){
        ...
        if(this.randomIntNumber()){
            ...
            this.person.patronymic = `${this.randomMaleName()}`; // рандомное мужское отчество

            // if (this.randomMaleName().slice(-2) === 'ий') {
            //     this.person.patronymic = `${this.randomMaleName().replace('ий', 'иевич')}`
            // }
            // if (this.randomMaleName().slice(-2) == 'ей'){
            //     this.person.patronymic = `${this.randomMaleName().replace('ей', 'еевич')}`
            // }
            // if (this.randomMaleName().slice(-2) == 'та'){
            //     this.person.patronymic = `${this.randomMaleName().replace('та', 'тович')}`
            // }
            // if (this.randomMaleName().slice(-2) == 'ем'){
            //     this.person.patronymic = `${this.randomMaleName().replace('ем', 'емович')}`
            // }
            // if (this.randomMaleName().slice(-2) == 'ий' || 'ей' || 'та' || 'ем'){
            //     this.person.patronymic = `${this.randomMaleName()}ович`
            // }
            ...
            this.person.patronymic = `${this.randomMaleName()}`; // рандомное женское отчество
            ...
            // }
            // if (this.randomMaleName().slice(-2) == 'ий' || 'ей' || 'та' || 'ем'){
            //     this.person.patronymic = `${this.randomMaleName()}овна`
            // }
